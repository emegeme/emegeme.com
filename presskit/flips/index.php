...
echo '					<p class="images-text">'. tlHtml('There are far more images available for FLIPS, but these are the ones we felt would be most useful to you. If you have specific requests, please do <a href="#contact">contact us</a>! We can provide screenshots in all the 8 languages supported by FLIPS: English, Spanish, French, Italian, German, Russian, Japanese and Simplified Chinese.', COMPANY_TITLE) .'</p>
